import {CharacterSimson} from "./Components/CharacterSimson";
import {CharacterMorty} from "./Components/CharacterMorty"
...
const App = () => {
  ...
  return (
      ...
      <div>
          {simpsons.map(simpson => <CharacterSimson CharacterSimson={simpson} key={simpson.id}/>)}
          {Mortys.map(Morty => <CharacterMorty CharacterMorty={Morty} key={Morty.id}/>)}
      </div>
